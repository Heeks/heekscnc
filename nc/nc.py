...
def drill(x=None, y=None, dwell=None, depth_params = None, retract_mode=None, spindle_mode=None):
    creator.drill(x, y, dwell, depth_params, retract_mode, spindle_mode)
